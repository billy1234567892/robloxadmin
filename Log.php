...
$con=mysqli_connect("localhost","496970","password","496970");
...
echo("<a id='a' title='The backup entries' href='Process2.php'><b>View Database Backup</b></a>");
...
$count = $count+1;
  echo("<tr><td>" . $row['pp'] . "</td>" . "<td>" . "<a id='a' href='http://www.roblox.com/User.aspx?username=" . $row['username'] . "'>" . $row['username'] . "</a>" . "</td>" . "<td>" . $row['changetime'] . "</td>" . "<td>" . "<a id='a' href='http://www.roblox.com/User.aspx?username=" . $row['changer'] . "'>" . $row['changer'] . "</a>" . "</td></tr>");
}}
else{
$count = $count+1;
  echo("<tr><td>" . $row['pp'] . "</td>" . "<td>" . "<a id='a' href='http://www.roblox.com/User.aspx?username=" . $row['username'] . "'>" . $row['username'] . "</a>" . "</td>" . "<td>" . $row['changetime'] . "</td>" . "<td>" . "<a id='a' href='http://www.roblox.com/User.aspx?username=" . $row['changer'] . "'>" . $row['changer'] . "</a>" . "</td></tr>");
...
elseif($ok==true){
echo("<br/><br/><div id='header'><br/><a href='Log.php' class='logbutton'>Refresh</a> | <a href='Process.php' class='logbutton'>Back</a> | <a href='Users.php' class='logbutton'>Accounts</a> | <a id='logout' href='Google.php' class='logbutton'>Logout</a><p></p></div><br/>Your security level is too low.");
}
else{
$_SESSION["password"]="";
